...
bool db_browser::connect_to_database()
{
	...
	if(!dbase.open())
	{
		...
		{
			QMessageBox::information(this, "Database not found", "The database server is valid, but I didn't find a 'GWakonlan' database.  To use this functionality, create a database schema called 'GWakeonlan' and try again.");
		}
		else
		{
